...
def mainPage(request):
    ...
    return render(request, 'main.html', {'signed_in': True, 'best_events': best_events,'newest_event':new_event,'types':types})
...
def buy(request):
    return render(request, 'buy.html', {'signed_in': True})
